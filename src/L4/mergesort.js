...
//sortarray(20, 50) for level 4.
export function sortArray(arrSize, maxVal){
    let array = createArray(arrSize, maxVal);     //create an array with n random numbers
    ...
    sorted = myJSON;
    printSorted();    //uncomment to see in console the steps.
